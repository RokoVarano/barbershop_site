...
const Presentation = () => (
  <div className="presentation-box">
    ...
    <div className="presentation-about">
      <h1>Alfa - Kayser</h1>
      <p>
        Et karl marx hairy kid at school, hairy kid at school cesar romero et karl marx
        horseshoe cesar romero socially mobile face broom socially mobile super mario,
